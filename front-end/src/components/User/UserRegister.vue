      ...
      <form v-on:submit.prevent="handleSubmit" class="space-y-5">
        ...
        <div class="pt-2 flex flex-col gap-4">
          ...
          <button
            ...
            class="cursor-pointer w-full bg-white hover:bg-gray-300 text-[#1c1516] font-bold py-3.5 rounded-[12px] transition-transform active:scale-95 flex items-center justify-center gap-3">
